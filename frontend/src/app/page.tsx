          ...
          <div className="max-w-2xl mx-auto w-full">
            <div className="mb-6 flex gap-2">
              <input
                ...
                placeholder="Добавьте задачу... (Enter - сохранить)"
              ...
              <button
                ...
                className="w-12 cursor-pointer flex items-center justify-center bg-blue-600 hover:bg-blue-700 disabled:bg-slate-300 text-white rounded-xl font-bold text-xl transition-colors"
            ...
            <div className="space-y-3">
              {tasks.length === 0 ? (
                <p className="text-center text-slate-500 py-8">Список пуст. Добавьте первую задачу!</p>
              ) : (
                tasks.map((task) => (
